...
function populateWeapon()
{
    ...
    success: function(data)
    {
      ...
      var attributeName;
      if (name.includes("Batman") || name.includes("Wonder Woman"))
      {
        attributeName = "Strength: ";
        strength += Number(data[0].primaryValue);
      }
      else if (name.includes("The Flash") || name.includes("Aquaman"))
      {
        attributeName = "Agility: ";
        agility += Number(data[0].primaryValue);
      }
      else if (name.includes("Green Lantern") || name.includes("Superman"))
      {
